...
- Last completed task: Added fact-level quiz deduplication, private shortfall drafts, one bounded Generate more action, and teacher-authored questions for all five types. Automated and live-emulator verification passed.
