...
void main() {
  ...
  group('MaterialViewerScreen Tests', () {
    testWidgets('renders converting state with quick actions for pending PPTX', (tester) async {
    ...
    testWidgets('renders conversion failed state with fallback options for failed DOCX', (tester) async {
      tester.view.physicalSize = const Size(375, 812);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets('toggles between preview and extracted text view', (tester) async {
      tester.view.physicalSize = const Size(375, 812);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      ...
      expect(find.text('Algorithm analysis involves asymptotic bounds.'), findsOneWidget);
    ...
    testWidgets('renders properly without RenderFlex overflow on desktop (1440x900)', (tester) async {
      ...
      final material = MaterialModel(
        ...
        fileType: 'pptx',
        fileRef: 'uploads/t1/mat_desktop/Comprehensive_Research_Guide_Volume_1.pptx',
        status: 'ready',
        conversionStatus: 'pending',
      ...
      expect(tester.takeException(), isNull);
      expect(find.text('Comprehensive_Research_Guide_Volume_1.pptx'), findsOneWidget);
      expect(find.text('Open Original (PPTX)'), findsOneWidget);
    });

    testWidgets('renders directly with extracted text if initialShowExtractedText is true', (tester) async {
      final material = MaterialModel(
        id: 'mat_initial_text',
        teacherId: 't1',
        classId: 'c1',
